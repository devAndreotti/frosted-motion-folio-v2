...
export const pt: Strings = {
  ...
  header: {
    roles: ['propósito real.', 'que resolvem problemas.', 'bem pensados.', 'com boa DX.'],
    lead1: 'Desenvolvo',
    lead2: 'produtos com',
    badge: 'Full Stack & IA',
  ...
  skills: {
    ...
    radarDesc: 'Mesma leitura do bento, em outro formato — nível relativo (1 a 5) nas seis frentes que mais uso.',
  ...
  activity: {
    ...
    emptyState: 'Sem atividade pública recente —',
    emptyStateLink: 'confira o perfil',
